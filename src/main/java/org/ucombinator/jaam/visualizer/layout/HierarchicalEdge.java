...
public abstract class HierarchicalEdge<T extends AbstractLayoutVertex<T>> implements LayoutEdge<T>, Comparable<HierarchicalEdge<T>>
{
    ...
    public HierarchicalEdge(T src, T dest, EDGE_TYPE edgeType) {
        this.src = src;
        this.dest = dest;
        this.type = edgeType;
        graphics = new Group();
    ...
    public int compareTo(HierarchicalEdge<T> that) {
    ...
    protected GUINode<T> getSrcParent()
    {
