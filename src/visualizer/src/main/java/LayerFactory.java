...
public class LayerFactory {
	...
	static AbstractVertex get2layer(Graph graph){
		...
		/*We are adding a vertex for each method to the methodGraph*/
		...
		/*We are adding edges to the methodGraph*/
		...
		while(absIt.hasNext()){
			...
			while(innerIt.hasNext()){
				if(methodVertex.getSmallest_instruction_line()==-1){
					methodVertex.setSmallest_instruction_line(innerIt.next().getSmallest_instruction_line());
				}else{
